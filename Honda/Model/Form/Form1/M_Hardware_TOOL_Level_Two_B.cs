...
namespace Honda.Model.Form
{
    ...
    /// </summary>
    [Serializable]
    public class M_Hardware_TOOL_Level_Two_B : List<MItem_Tool_A>, IHardwareTool
    {
        /// <summary>
        /// 组的ID 
        /// </summary>
        ...
        public M_Hardware_TOOL_Level_Two_B()
        {
            _hardwareTool_Form_Typle = HardwareTool_Form_Typle._TOOL_SHEET;
        }
